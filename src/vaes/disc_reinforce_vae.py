...
Description: Reinforce discrete (categorical latent space) VAE, continous output fmnist
...
n_name = "RD_VAE_{}e_{}.pth".format(args.epochs, dset)
plots_pth = '../../plots/RD_VAE/' + dset + '/'
