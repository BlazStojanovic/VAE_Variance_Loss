...
train_loader = torch.utils.data.DataLoader(
    datasets.FashionMNIST('../../../shared/Data', train=True, download=True,
                   transform=transforms.ToTensor()),
    batch_size=args.batch_size, shuffle=True, **kwargs)
test_loader = torch.utils.data.DataLoader(
    datasets.FashionMNIST('../../../shared/Data', train=False, transform=transforms.ToTensor()),
    batch_size=args.batch_size, shuffle=True, **kwargs)
...
n_name = "V_VAE_{}e_{}.pth".format(args.epochs, dset)
plots_pth = '../../plots/V_VAE/' + dset + '/'
